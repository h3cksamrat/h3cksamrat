...
[<img align="left" alt="Samrat's Twitter" width="40px" src="./assets/twitter.svg" class="social_icons" />](https://twitter.com/sam__neupane)
[<img align="left" alt="Samrat's NPM" width="40px" src="./assets/npm.svg" class="social_icons" />](https://www.npmjs.com/~h3cksamrat)
[<img align="left" alt="Samrat's Github" width="40px" src="./assets/github.svg" class="social_icons" />](https://github.com/h3cksamrat)

<br> <br> <br>

### Languages and Tools:
[![My Skills](https://skills.thijs.gg/icons?i=git,nodejs,js,ts,express,nestjs,react,next,linux,bash,mongodb,postgresql,python,css,html,docker,flask&theme=dark)](https://skills.thijs.gg)
